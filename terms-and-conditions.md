...
- **Software**: Multi-tenant SaaS platform, proprietary and open-source software and firmware.
- **Hardware**: IoT devices, microcontroller-based controllers, and accessories.
- **Support & Documentation**: Knowledge base, community forums, and optional paid technical support.

These Terms apply to all editions, versions, and deployments of IgorBox software and hardware, whether hosted by us, self-hosted by you, or installed on your devices.

---

## 2. Eligibility

You must be at least **18 years old** or the legal age of majority in your jurisdiction to use our Services. By using our Services, you represent that you meet these requirements.
...
- **Open-Source Software**: Certain IgorBox software is released under open-source licenses (e.g., MIT, GPL). Those licenses govern your rights for that software and are bundled with the open-source code.
- **Proprietary Software**: Licensed under a paid, proprietary license. You may not copy, modify, decompile, reverse-engineer, or redistribute without written consent.
- **Hardware Designs**: IgorBox hardware schematics, PCB layouts, and firmware are proprietary unless otherwise noted.
- All trademarks, logos, and branding are property of Rising Orchards LLC.
...
- Interfere with or disrupt the Services or associated networks.
...
6.1 **Secure Boot** – IgorBox hardware is designed with secure boot technology to ensure only digitally signed, official IgorBox firmware can run on the device.
...
We may incorporate artificial intelligence (AI) technologies into our Services for purposes such as analytics, automation, and feature enhancement.  
We may also collect and process **anonymized** or **aggregated** data derived from your use of the Services to:
...
- Payment must be received before shipment or license activation.
- Enterprise subscriptions renew according to the terms in your order confirmation.

---

## 9. Shipping and Returns

- Hardware is shipped to the address provided at checkout.
- Returns and refunds follow our **Return Policy** (https://store.igorbox.com/return-policy)
...
- Any dispute, claim, or controversy arising out of or relating to these Terms or the Services will be resolved by binding arbitration on an individual basis, rather than in court, except that you and we may assert claims in small claims court if they qualify.
- The Federal Arbitration Act and federal arbitration law apply to this agreement. Arbitration will be administered by a reputable arbitration provider under its applicable rules. The venue will be Florida, USA, unless otherwise required by law. Judgment on the award may be entered in any court with jurisdiction.
- Class and representative actions are not permitted. YOU AND WE AGREE THAT EACH MAY BRING CLAIMS AGAINST THE OTHER ONLY IN YOUR OR ITS INDIVIDUAL CAPACITY AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS OR REPRESENTATIVE PROCEEDING.
- Opt-Out: You may opt out of arbitration within 30 days of first accepting these Terms by sending a written notice to help@igorbox.com with subject line “Arbitration Opt-Out,” including your name and the email address associated with your account.
