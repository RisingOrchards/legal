...
If a covered defect arises and a valid claim is received within the applicable period, IgorBox will, at its option and expense:

- Repair the product; or
- Replace the product with an equivalent product that is new or refurbished; or
- If repair or replacement is not commercially reasonable, refund the purchase price paid.

These remedies are your exclusive remedies under this Warranty.
...
- Products with removed, altered, or defaced serial numbers/labels.

Software and firmware are provided "as is" and are not covered by this hardware Warranty (except that official IgorBox firmware is warranted to operate on compatible IgorBox hardware as documented).

---

## 4. How to Obtain Warranty Service

1. Contact IgorBox Support at **help@igorbox.com** with your order number, serial number, a description of the issue, and troubleshooting steps taken.
2. IgorBox may provide remote diagnostics and/or require proof of purchase.
3. If your claim is approved, you will receive a Return Merchandise Authorization (RMA) number and instructions.
4. Ship the product as instructed with the RMA number clearly visible on the exterior packaging.

Shipping responsibilities:

- DOA within 30 days: IgorBox provides a prepaid shipping label for return and covers outbound shipping of the replacement.
- Warranty after 30 days: You are responsible for inbound shipping to IgorBox; IgorBox covers outbound shipping for approved warranty repairs/replacements.
- Risk of loss remains with the sender until the product is received by IgorBox, except when you use an IgorBox‑provided prepaid label.
...
All returned products are subject to inspection. If a returned product is found to be ineligible for warranty service (e.g., due to exclusions in Section 3), IgorBox will provide a quote for out‑of‑warranty repair or return it unrepaired at your expense.
...
## 7. Ownership of Replaced Parts

Any hardware or parts replaced under this Warranty become the property of IgorBox. Repaired or replaced products may contain new or previously used components equivalent to new in performance and reliability.

---

## 8. Governing Terms

This Warranty is governed by the IgorBox Terms and Conditions and applicable law. In case of conflict, the Terms and Conditions control.
